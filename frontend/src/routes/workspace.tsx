...
export const Route = createFileRoute("/workspace")({
  head: () => ({
    meta: [
      { title: "ClipCraft Workspace — Dashboard" },
      {
        name: "description",
        content:
          "ClipCraft workspace dashboard: recent video projects, media stats and quick actions to start editing.",
      },
      { property: "og:title", content: "ClipCraft Workspace — Dashboard" },
      {
